...
function checkCircusRides() {
  ...
  console.log("Enjoy the roller coaster!"); // this prints regardless of the answer because it is not connected with an else statement
}

// change the function above to exit as early as possible

/* when returning in the console without reusing immediately, javascript will save that value in its
memory until it is called to be used
*/
