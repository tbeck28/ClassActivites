...
/*let falsies = data.filter(function(incomplete){
  return incomplete.completed === false;
})

const incompleted = data.filter(tasks => !tasks.complete)
...
/*
let person = data.filter(tasks => tasks.userId === 6)
console.log(person)
*/

// filter for tasks with a title less than 24 characters long

const char = data.filter(task => task.title.length < 24)
console.log(char)
